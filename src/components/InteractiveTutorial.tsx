...
export const InteractiveTutorial: React.FC<InteractiveTutorialProps> = ({
  ...
  const L = useMemo(() => {
    ...
    return {
      ...
      // ── Tools ──────────────────────────────────────────────────────────────
      tool_cal_title: pick({ 
        'English': 'Calorie Tracker', 
        'Bahasa Indonesia': 'Pelacak Kalori',
        'Español': 'Contador de Calorías',
        'Chinese': '卡路里追踪器',
        'Hindi': 'कैलोरी ट्रैकर',
        'Arabic': 'متتبع السعرات الحرارية',
        'Portuguese': 'Contador de Calorias',
        'Français': 'Suivi des Calories',
        'Japanese': 'カロリートラッカー',
        'Deutsch': 'Kalorien-Tracker'
      }),
      tool_cal_desc: pick({ 
        'English': 'Track your daily food intake, log meals, and monitor your calories to stay fit.', 
        'Bahasa Indonesia': 'Catat asupan makanan harian, pantau konsumsi nutrisi, dan jaga berat badan idealmu.',
        'Español': 'Registra tu consumo diario de alimentos, anota comidas y monitorea tus calorías para mantenerte en forma.',
        'Chinese': '记录您的每日食物摄入量、记录膳食并监测卡路里以保持健康。',
        'Hindi': 'फिट रहने के लिए अपने दैनिक भोजन सेवन को ट्रैक करें, भोजन लॉग करें, और कैलोरी की निगरानी करें।',
        'Arabic': 'تتبع تناولك اليومي من الطعام، وسجل الوجبات، وراقب سعراتك الحرارية للحفاظ على لياقتك.',
        'Portuguese': 'Rastreie sua ingestão diária de alimentos, registre refeições e monitore suas calorias para manter a forma.',
        'Français': 'Suivez votre apport alimentaire quotidien, enregistrez vos repas et surveillez vos calories pour rester en forme.',
        'Japanese': '毎日の食事摂取量を追跡し,食事を記録し,カロリーを監視して健康を維持しましょう。',
        'Deutsch': 'Verfolge deine tägliche Nahrungsaufnahme, protokolliere Mahlzeiten und überwache deine Kalorien, um fit zu bleiben.'
      }),
      tool_pomo_title: pick({ 
        'English': 'Pomodoro Focus Timer', 
        'Bahasa Indonesia': 'Timer Pomodoro',
        'Español': 'Temporizador Pomodoro',
        'Chinese': '番茄专注计时器',
        'Hindi': 'पोमोडोरो फोकस टाइमर',
        'Arabic': 'مؤقت التركيز بومودورو',
        'Portuguese': 'Temporizador Pomodoro',
        'Français': 'Minuteur de Concentration Pomodoro',
        'Japanese': 'ポモドーロフォーカスタイマー',
        'Deutsch': 'Pomodoro-Fokus-Timer'
      }),
      tool_pomo_desc: pick({ 
        'English': 'Use focus sessions with ambient lo-fi soundscapes to work and study with maximum efficiency.', 
        'Bahasa Indonesia': 'Gunakan sesi fokus berwaktu yang diiringi musik lo-fi tenang untuk belajar dan bekerja dengan produktif.',
        'Español': 'Usa sesiones de enfoque con paisajes sonoros lo-fi ambientales para trabajar y estudiar con la máxima eficiencia.',
        'Chinese': '利用环境低保真音效的专注会话，实现最高效的工作和学习。',
        'Hindi': 'अधिकतम दक्षता के साथ काम करने office और अध्ययन करने के लिए परिवेशी लो-फाई साउंडस्केप के साथ फोकस सत्रों का उपयोग करें।',
        'Arabic': 'استخدم جلسات التركيز مع الأصوات الهادئة والموسيقى لتعمل وتدرس بأقصى قدر من الكفاءة.',
        'Portuguese': 'Use sessões de foco com trilhas sonoras lo-fi ambientes para trabalhar e estudar com máxima eficiência.',
        'Français': 'Utilisez des sessions de concentration avec des ambiances sonores lo-fi pour travailler et étudier avec une efficacité maximale.',
        'Japanese': '環境ロファイサウンドスケープを使用したフォーカスセッションを活用し,最高効率で作業や勉強を行いましょう。',
        'Deutsch': 'Nutze Fokussitzungen mit Lofi-Umgebungssounds, um mit maximaler Effizienz zu arbeiten und zu lernen.'
      }),
      tool_work_title: pick({ 
        'English': 'Workout Rep Counter', 
        'Bahasa Indonesia': 'Workout Counter',
        'Español': 'Contador de Ejercicios',
        'Chinese': '健身次数计数器',
        'Hindi': 'वर्कआउट रेप काउंटर',
        'Arabic': 'عداد تكرارات التمارين',
        'Portuguese': 'Contador de Exercícios',
        'Français': 'Compteur de Répétitions',
        'Japanese': 'ワークアウトレップカウンター',
        'Deutsch': 'Workout-Wiederholungszähler'
      }),
      tool_work_desc: pick({ 
        'English': 'Keep count of your fitness repetitions (pushups, squats) automatically.', 
        'Bahasa Indonesia': 'Hitung repetisi latihan fisikmu (seperti push-up atau squat) secara otomatis.',
        'Español': 'Lleva el conteo de tus repeticiones de ejercicio (flexiones, sentadillas) automáticamente.',
        'Chinese': '自动计数您的健身重复次数（俯卧撑、深蹲）。',
        'Hindi': 'अपने फिटनेस प्रतिनिधि (पुशअप्स, स्क्वाट्स) को स्वचालित रूप से गिनें।',
        'Arabic': 'احسب تكرارات تمارين اللياقة البدنية (تمارين الضغط، القرفصاء) تلقائياً.',
        'Portuguese': 'Conte suas repetições de fitness (flexões, agachamentos) automaticamente.',
        'Français': 'Comptez automatiquement vos répétitions de fitness (pompes, squats).',
        'Japanese': 'フィットネス of 反復回数（プッシュアップ、スクワット）を自動的にカウントします。',
        'Deutsch': 'Zähle deine Fitness-Wiederholungen (Liegestütze, Kniebeugen) automatisch.'
      }),
      tool_breath_title: pick({ 
        'English': 'Deep Breathing Guide', 
        'Bahasa Indonesia': 'Deep Breathing',
        'Español': 'Guía de Respiración Profunda',
        'Chinese': '深呼吸指南',
        'Hindi': 'गहरी सांस लेने की गाइड',
        'Arabic': 'دليل التنفس العميق',
        'Portuguese': 'Guia de Respiração Profunda',
        'Français': 'Guide de Respiration Profonde',
        'Japanese': '深呼吸ガイド',
        'Deutsch': 'Tiefenatmungs-Anleitung'
      }),
      tool_breath_desc: pick({ 
        'English': 'Calm your heart, reduce anxiety, and clear your mind with interactive breathing guides.', 
        'Bahasa Indonesia': 'Tenangkan pikiran, kurangi stres, dan kembalikan fokusmu lewat panduan pernapasan interaktif.',
        'Español': 'Calma tu corazón, reduce la ansiedad y despeja tu mente con guías de respiración interactivas.',
        'Chinese': '通过互动式呼吸指南，平静你的内心，减轻焦虑，理清思绪。',
        'Hindi': 'इंटरैक्टिव श्वास गाइड के साथ अपने दिल को शांत करें, चिंता कम करें, और अपने दिमाग को साफ करें।',
        'Arabic': 'هدئ قلبك، وقلل من القلق، واصفِ ذهنك من خلال أدلة التنفس التفاعلية.',
        'Portuguese': 'Acalme seu coração, reduza a ansiedade e clareie sua mente com guias interativos de respiração.',
        'Français': 'Calmez votre cœur, réduisez l\'anxiété et libérez votre esprit avec des guides respiratoires interactifs.',
        'Japanese': 'インタラクティブな呼吸ガイドで,心を落ち着かせ,不安を和らげ,頭をすっきりさせましょう。',
        'Deutsch': 'Beruhige dein Herz, baue Ängste ab und mache deinen Kopf frei mit interaktiven Atemanleitungen.'
      }),
      tool_books_title: pick({ 
        'English': 'Library & Summaries', 
        'Bahasa Indonesia': 'Ringkasan Buku',
        'Español': 'Biblioteca y Resúmenes',
        'Chinese': '图书馆与书摘',
        'Hindi': 'लाइब्रेरी और सारांश',
        'Arabic': 'المكتبة والملخصات',
        'Portuguese': 'Biblioteca e Resumos',
        'Français': 'Bibliothèque et Résumés',
        'Japanese': 'ライブラリと要約',
        'Deutsch': 'Bibliothek & Zusammenfassungen'
      }),
      tool_books_desc: pick({ 
        'English': 'Access bite-sized key summaries of world-class self-development and habit building books.', 
        'Bahasa Indonesia': 'Baca intisari dan ringkasan penting dari buku-buku pengembangan diri terbaik di dunia.',
        'Español': 'Accede a resúmenes clave y concisos de libros de desarrollo personal y creación de hábitos de clase mundial.',
        'Chinese': '获取世界级自我提升和习惯养成书籍的简明核心摘要。',
        'Hindi': 'विश्व स्तरीय आत्म-विकास और आदत निर्माण पुस्तकों के संक्षिप्त मुख्य सारांश तक पहुँचें।',
        'Arabic': 'احصل على ملخصات موجزة ومفيدة لأفضل كتب تطوير الذات وبناء العادات في العالم.',
        'Portuguese': 'Acesse resumos práticos de livros de desenvolvimento pessoal e criação de hábitos de classe mundial.',
        'Français': 'Accédez à des résumés clés de livres de développement personnel et de création d\'habitudes de classe mondiale.',
        'Japanese': '世界クラスの自己開発や習慣構築に関する本の簡潔な要約にアクセスしましょう。',
        'Deutsch': 'Erhalte Zugriff auf kurze Zusammenfassungen weltweiter Bestseller zu Selbstentwicklung und Gewohnheitsbildung.'
      }),
      tool_math_title: pick({ 
        'English': 'Math Racing Game', 
        'Bahasa Indonesia': 'Math Racing',
        'Español': 'Juego de Carreras Matemáticas',
        'Chinese': '数学赛车游戏',
        'Hindi': 'मैथ रेसिंग गेम',
        'Arabic': 'لعبة سباق الرياضيات',
        'Portuguese': 'Jogo de Corrida Matemática',
        'Français': 'Jeu de Course de Mathématiques',
        'Japanese': '数学レーシングゲーム',
        'Deutsch': 'Mathe-Rennspiel'
      }),
      tool_math_desc: pick({ 
        'English': 'Boost your brain speed and focus by solving rapid arithmetic quizzes under time pressure.', 
        'Bahasa Indonesia': 'Latih kecepatan berpikir otakmu lewat permainan kuis matematika cepat berpacu dengan waktu.',
        'Español': 'Aumenta la velocidad de tu cerebro y tu enfoque resolviendo cuestionarios aritméticos rápidos bajo presión de tiempo.',
        'Chinese': '通过在时间压力下解决快速算术测验，提升脑速和专注力。',
        'Hindi': 'समय के दबाव में तेजी से अंकगणितीय क्विज़ को हल करके अपने मस्तिष्क की गति और फोकस को बढ़ाएं।',
        'Arabic': 'عزز سرعة عقلك وتركيزك عن طريق حل اختبارات الحساب السريعة تحت ضغط الوقت.',
        'Portuguese': 'Aumente a velocidade do seu cérebro e seu foco resolvendo questionários aritméticos rápidos sob pressão do tempo.',
        'Français': 'Boostez votre vitesse cérébrale et votre concentration en résolvant des quiz d\'arithmétique rapides sous pression du temps.',
        'Japanese': '制限時間内に素早く算数クイズを解くことで,脳の回転スピードと集中力を高めましょう。',
        'Deutsch': 'Steigere deine Gehirngeschwindigkeit und deinen Fokus, indem du unter Zeitdruck schnelle Kopfrechenaufgaben löst.'
      }),
    };
